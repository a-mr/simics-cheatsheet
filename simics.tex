...
Assignments are equivalent to casts and hence can truncate:
        ...
        \begin{code}
            ...
            \vspace{0.1cm}
            local int16 \tikzmark{b} $x$ = $\overbrace{\ind i + j; \ind }^{\text{calculated as int64 $\rightarrow$ 0x8001} \tikzmark{a}}$ \DrawBottomReverse{black}{truncated to int16} \cmtd{finally results in $x == 1$}
            \vspace{0.3cm}
        \end{code}
